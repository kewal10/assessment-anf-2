...
<head>
    ...
    <title>All New Fashion | Men 2</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <ul class="dropdown-menu">
                <li><a href="men-2.php?theme=mariner">Mariner</a></li>
                <li><a href="men-2.php?theme=bluewood">Bluewood</a></li>
              </ul>
          </ul>
          </ul>
    ...
    <!--  Latest   -->
     <div class="container">
       <h5 class="f-s-c"><a id="btn-decrease" href="#"><i class="fa fa-minus" aria-hidden="true"></i></a>Font size contorller<a id="btn-increase" href="#"><i class="fa fa-plus" aria-hidden="true"></i></a></h5>
        ...
        <div class="container">
        <h1 class="text-center text-uppercase clothe-title">Men Clothe 2</h1>
        <div class="row">
            <div class="col-md-4 text-center latest-item col-xs-12">
                ...
                <h4 class="text-left">Men clothe 10</h4>
            </div>
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-11.jpg" alt="img 11" class="img-responsive text-center center-block" />
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $39.99</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 11</h4>
            </div>
            <div class="col-md-4 text-center latest-item clearfix col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-12.jpg" alt="img 12" class="img-responsive text-center center-block" />
                    <div class="price">
        ...
        <div class="row">
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-13.jpg" alt="img 13" class="img-responsive text-center center-block" />
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $79.00</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 13</h4>
            </div>
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-14.jpg" alt="img 14" class="img-responsive text-center center-block" />
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> 49.85</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 14</h4>
            </div>
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-15.jpg" alt="img 15" class="img-responsive center-block"/>
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $19.99</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 15</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-16.jpg" alt="img 16" class="img-responsive text-center center-block" />
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $79.00</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 16</h4>
            </div>
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-17.jpg" alt="img 17" class="img-responsive text-center center-block" />
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> 49.85</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 17</h4>
            </div>
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-18.jpg" alt="img 18" class="img-responsive center-block"/>
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $19.99</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 18</h4>
            </div>
        </div>
    </div>
