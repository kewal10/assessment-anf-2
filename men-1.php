...
<head>
    ...
    <title>All New Fashion | Men 1</title>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <ul class="dropdown-menu">
                <li><a href="men-1.php?theme=mariner">Mariner</a></li>
                <li><a href="men-1.php?theme=bluewood">Bluewood</a></li>
              </ul>
          </ul>
          </ul>
    ...
    <!--  Latest   -->
     <div class="container">
       <h5 class="f-s-c"><a id="btn-decrease" href="#"><i class="fa fa-minus" aria-hidden="true"></i></a>Font size contorller<a id="btn-increase" href="#"><i class="fa fa-plus" aria-hidden="true"></i></a></h5>
        ...
        <div class="container">
        <h1 class="text-center text-uppercase clothe-title">Men Clothe 1</h1>
        <div class="row">
            ...
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-2.jpg" alt="img 2" class="img-responsive text-center center-block" />
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $39.99</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 2</h4>
            </div>
        ...
        <div class="row">
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-4.jpg" alt="img 4" class="img-responsive text-center center-block" />
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $79.00</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 4</h4>
            </div>
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-5.jpg" alt="img 5" class="img-responsive text-center center-block" />
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> 49.85</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 5</h4>
            </div>
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-6.jpg" alt="img 6" class="img-responsive center-block"/>
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $19.99</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 6</h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-7.jpg" alt="img 7" class="img-responsive text-center center-block" />
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $79.00</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 7</h4>
            </div>
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                ...
                <h4 class="text-left">Men clothe 8</h4>
            </div>
            <div class="col-md-4 text-center latest-item col-xs-12">
                <div class="add-to-cart">
                    <img src="img/male/img-m-9.jpg" alt="img 9" class="img-responsive center-block"/>
                    <div class="price">
                        <a href="#"><i class="fa fa-cart-plus cart" aria-hidden="true"> $19.99</i></a>
                    </div>
                </div>
                <h4 class="text-left">Men clothe 9</h4>
            </div>
        </div>
    </div>
